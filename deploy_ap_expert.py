...
"""
    ...
    with open("app_expert.py", "w") as f:
        f.write(app_py_content)
        
    print("Uploading Expert Bypass app.py to Hub...")
    api.upload_file(
        path_or_fileobj="app_expert.py",
        path_in_repo="app.py",
        repo_id=repo_id,
        repo_type="space"
    )
    
    print(f"✅ Activepieces expertly deployed! URL: https://{username}-{space_name}.hf.space")
