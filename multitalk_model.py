...
from AptAvatar.wan.modules.attention import flash_attention
...
class WanModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        _, T, H, W = x[0].shape  #x[0].shape F,T,C,H,W
        ...
        latter_first_frame_audio_emb = rearrange(latter_first_frame_audio_emb, "b n_t n w s c -> b n_t (n w) s c")  # b n_t (1 3) s c
        latter_last_frame_audio_emb = latter_frame_audio_emb[:, :, -1:, middle_index:, ...] 
        latter_last_frame_audio_emb = rearrange(latter_last_frame_audio_emb, "b n_t n w s c -> b n_t (n w) s c")  # b n_t (1 3) s c
        latter_middle_frame_audio_emb = latter_frame_audio_emb[:, :, 1:-1, middle_index:middle_index+1, ...] 
        latter_middle_frame_audio_emb = rearrange(latter_middle_frame_audio_emb, "b n_t n w s c -> b n_t (n w) s c")  # b n_t (2 1) s c
